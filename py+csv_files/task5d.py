...
fig.text(0.3, -0.05, 'Year of observation', ha='center',fontsize=15)
fig.text(-0.05, 0.5, 'Average temperature', va='center', rotation='vertical',fontsize=15)
a= sys.argv[1]
if int(a)==1:
  plt.savefig('task5d.png',bbox_inches='tight')
  print(os.getcwd())
else:
  plt.tight_layout()
  plt.show()
